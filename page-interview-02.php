...
<main class="interview-detail-page">
    ...
    <div class="hero-img-placeholder">
        <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/sousai_aibasan.webp">
                    <source type="image/jpg"  srcset="<?php echo get_template_directory_uri(); ?>/assets/images/sousai_aibasan.jpg">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/sousai_aibasan.jpg"
                    alt="フローラ森山店川崎さんの写真"
