...
<main class="interview-detail-page">
    ...
    <div class="hero-img-placeholder">
        <picture>
                    <source type="image/webp" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/sousai_takeutisan.webp">
                    <source type="image/jpg"  srcset="<?php echo get_template_directory_uri(); ?>/assets/images/sousai_takeutisan.jpg">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/sousai_takeutisan.jpg"
                    alt="葬祭部竹内さんの写真"
